...
- [개발](./dev/dev.md)
  - [언어 / framework](./dev/lang/lang.md)
    - [rust](./dev/rust/rust.md)
      - [rust 구조체 출력](./dev/rust/00001.md)
      - [rust 1.79 + iced 0.12.1 한글 폰트를 기본으로 설정하기](./dev/rust/00002.md)
      - [rust 코드에 document 달기](./dev/rust/00003.md)
      - [visual studio code에서 rust traits 한 번에 만들기 단축키: ctrl + .](./dev/rust/00004.md)
      - [rust 1.79 + iced 0.12.1 한글 나오게 하기](./dev/rust/00005.md)
      - [rust에서 ffmpeg 개발하기](./dev/rust/00006.md)

    - [winui3](./dev/winui3/winui3.md)
  ...
  - [vscode](./dev/vscode/vscode.md)
    - [extensions](./dev/vscode/extensions/extensions.md)
      - [vscode에서 pdf 파일 보기 extension](./dev/vscode/extensions/00001.md)
      - [md파일 내 이미지 특정 폴더에 붙여넣기](./dev/vscode/extensions/00002.md)
    - [snippets](./dev/vscode/snippets/snippets.md)
      - [snippet 만들기](./dev/vscode/snippets/00001.md)
